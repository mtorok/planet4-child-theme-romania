...
* of allowed frame ancestors. (This means a list of sites on which P4 pages may be embedded, NOT where content may be embedded to P4 from.)
*/
function update_planet4_csp_allowed_frame_ancestors($allowlist) {
  $ancestors = [
    'suport.greenpeace.ro',
    'act.greenpeace.ro',
  ];
